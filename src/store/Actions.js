...
export const CHANGE_BALL_VALVE = 'UPDATE_CONNECTION_LATENCY'
export const CHANGE_DPR = 'UPDATE_CONNECTION_LATENCY'
...
export const UPDATE_BALL_VALVE = 'UPDATE_BALL_VALVE'
export const UPDATE_DPR = 'UPDATE_DPR'
