...
export const UPDATE_CONTROL_EMERGENCY_STOP = 'UPDATE_EMERGENCY_STOP'
export const UPDATE_CONTROL_POD_START = 'UPDATE_POD_START'
export const UPDATE_CONTROL_LEVITATION = 'UPDATE_LEVITATION'
export const UPDATE_CONTROL_BRAKE = 'UPDATE_BRAKE'
export const UPDATE_CONTROL_SPEED = 'UPDATE_SPEED_ACTUAL'
export const UPDATE_CONTROL_ACCELERATION = 'UPDATE_ACCELERATION_ACTUAL'
export const UPDATE_CONTROL_BALL_VALVE = 'UPDATE_BALL_VALVE'
export const UPDATE_CONTROL_DPR = 'UPDATE_DPR'
export const UPDATE_CONTROL_MAGWHEEL = 'UPDATE_MAGWHEEL_ACTUAL'
